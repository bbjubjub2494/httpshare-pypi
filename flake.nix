# The flake file is the entry point for nix commands
{
  ...
  outputs = inputs@{ self, fup, nixpkgs, ... }: fup.lib.mkFlake {
    ...
    outputsBuilder = channels: {
      packages.default = channels.nixpkgs.pythonPackages.callPackage nix/package.nix { };
      packages.python2 = channels.nixpkgs.python2Packages.callPackage nix/package.nix { };
      packages.python3 = channels.nixpkgs.python3Packages.callPackage nix/package.nix { };
